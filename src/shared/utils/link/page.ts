import { GetSearchVideosListRequestParams } from "@/features/search/api/getSearchVideosList";
...
export const getVideoDetailPageLink = (
  params: VideoDetailPageParams["params"]
) => {
